...
import { useToast } from "../../../@/components/ui/use-toast"; // Adjust the import path based on your actual file structure
  ...
  return (
    <>
      <div className="w-[96vw] h-[100vh] flex flex-col lg:flex lg:flex-row lg:gap-[3%] justify-center relative md:h-[100vh] lg:h-[97vh] p-[10px] lg:p-[20px] bg-transparent">
        ...
        <div
          className="w-[100%] h-[90%] lg:h-[98%] lg:block lg:w-[75%] mt-10 lg:mt-0 bg-chopbg rounded-xl"
          onClick={() => setOpen(true)}
        >
          <ChatTopBar clearChat={clearChat} />
          <div className="h-[90%] bg-chopbg w-full rounded-xl p-[3%] flex flex-col justify-between">
            <ChatBox
              chat={chats}
            ...
            />
            <div
              className="h-[5%] self-center px-2 bg-chop3gray/70 rounded-xl flex justify-center gap-2 items-center hover:bg-chop3gray"
            ...
            <div className="h-[10%] flex justify-center items-start relative">
              ...
              >
                <textarea
                  className="w-[80%] bg-transparent text-[10px] lg:text-sm h-max-[70%] h-[70%] resize-none outline-none text-white/95 text-sm p-2 rounded-xl whitespace-pre-wrap flex items-center mb-4 sm:mb-0"
